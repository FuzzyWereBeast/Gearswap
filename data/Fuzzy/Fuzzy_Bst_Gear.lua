function user_job_setup()
	...
	state.JugMode = M{['description']='Jug Mode','LuckyLulush','FatsoFargann','ScissorlegXerin','BlackbeardRandy','AttentiveIbuki','DroopyDortwin','WarlikePatrick','AcuexFamiliar'}
...
function init_gear_sets()
	...
	-- Weapons sets
	sets.weapons.PetPDTAxe = {main ="Eminent Axe",sub="Elm shield"}
	sets.weapons.DualWeapons = {main ="Eminent Axe",sub="Maiden Tabar"}	
	...
	sets.precast.JA.Charm = {
		head="Beast helm",		neck="Beast Whistle",	ear1="Melody Earring",
	...
	sets.engaged = {
		head="Outrider Mask",	neck="Focus Collar",		ear1="Opal Earring",		ear2="Suppanomimi",
		body="Outrider Mail",	hands="Outrider Mittens",	ring1="Assailant's ring",	ring2="Bloodbead ring",
		back="Bat cape",		waist="Headlong Belt",		legs="Outrider Hose",		feet="Outrider Greaves",
}
